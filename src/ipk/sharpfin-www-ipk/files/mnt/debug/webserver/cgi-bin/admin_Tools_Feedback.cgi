...
<p><i>If you need feedback or support, please contact us through the <a href="http://groups.google.co.uk/group/sharpfin" target="forum">forum</a></i></p>

<form id="form1" name="form1" method="post" action="http://sharpfin.zevv.nl/feedback.php">
