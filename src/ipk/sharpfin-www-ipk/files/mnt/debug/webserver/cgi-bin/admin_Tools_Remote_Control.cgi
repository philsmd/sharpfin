...
then
    ...
    if [ "$?" -eq 0 ]
    then
        STATUS="<div style='color:green'>The command \`$NAME\` was successfully sent to your radio<br></div>"
    else
        STATUS="<div style='color:red'>The command \`$NAME\` could NOT be sent to your radio<br></div>"
    fi
fi
...
<BODY onLoad="MM_preloadImages('mute.jpg')">
<h1>Sharpfin Radio Control Interface</h1>
$STATUS
..END
