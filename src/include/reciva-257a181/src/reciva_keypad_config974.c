/*
 * linux/reciva/reciva_keypad_config974.c
 *
...
{
  /* No keypad attached to this unit - only a remote */
...
{
  RKD_SKIP_PREVIOUS,  // Preset 1
  RKD_PLAY_PAUSE,     // Preset 2
  RKD_SKIP_NEXT,      // Preset 3
  RKD_PLAYBACK_MODE,  // Preset 4
  RKD_STOP,           // Preset 5
  RKD_BROWSE_QUEUE,   // Preset 6
  RKD_UNUSED,
  RKD_UNUSED,
  RKD_UNUSED,
  RKD_UNUSED,
...
static char acModuleName[] = "Reciva config974 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Keypad cf974");
MODULE_LICENSE("GPL");
