/*
 * linux/reciva/reciva_keypad_config973.c
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_POWER,     RKD_ALARM,        RKD_PRESET_6,     RKD_DOWN},    // Row 0
  {RKD_PRESET_4,  RKD_SELECT,       RKD_PRESET_7,     RKD_BACK},    // Row 1
  {RKD_PRESET_3,  RKD_REPLY,        RKD_SLEEP_TIMER,  RKD_UP},    // Row 2
  {RKD_PRESET_2,  RKD_PRESET_1,     RKD_AUDIO_SOURCE, RKD_UNUSED}     // Row 3
};
...
static char acModuleName[] = "Reciva config988 Keypad Driver";
