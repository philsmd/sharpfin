/*
 * linux/reciva/reciva_keypad_config991.c
 *
 ...
 * 
 * Keyboard driver for Reciva config991
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_UNUSED,  RKD_UNUSED,    RKD_SELECT,     RKD_UNUSED}, // Row 1
...
static char acModuleName[] = "Reciva Config991 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Config991 Keypad Driver");
MODULE_LICENSE("GPL");
