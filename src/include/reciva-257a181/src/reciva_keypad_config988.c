/*
 * linux/reciva/reciva_keypad_config988.c
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_5,  RKD_UNUSED,    RKD_UNUSED,       RKD_DOWN}, // Row 0
  {RKD_PRESET_4,  RKD_BACK,      RKD_UNUSED,       RKD_SELECT}, // Row 1
  {RKD_PRESET_3,  RKD_UNUSED,    RKD_SHIFT,        RKD_UP}, // Row 2
  {RKD_PRESET_2,  RKD_PRESET_1,  RKD_UNUSED,       RKD_UNUSED}  // Row 3
};
