/*
 * linux/reciva/reciva_keypad_config993.c
 *
 ...
 * 
 * Keyboard driver for config993 (Tangent Silver Radio)
 */
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_4,  RKD_PRESET_3,     RKD_PRESET_2, RKD_SELECT}, // Row 0
  {RKD_REPLY,     RKD_UNUSED,       RKD_PRESET_1, RKD_UNUSED}, // Row 1
  {RKD_UNUSED,    RKD_SELECT,       RKD_BACK,     RKD_UNUSED}, // Row 2
...
static char acModuleName[] = "Reciva config993 Keypad Driver";
