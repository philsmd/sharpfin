/*
 * linux/reciva/reciva_keypad_config986.c
 *
 ...
 * 
 * Keyboard driver for Reciva config986
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_IR_FM_MODE_SWITCH,    RKD_UNUSED,    RKD_POWER,        RKD_UNUSED}  // Row 3
};
...
static char acModuleName[] = "Reciva Config986 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Config986 Keypad Driver");
MODULE_LICENSE("GPL");
