/*
 * linux/reciva/reciva_keypad_config992.c
 *
 ...
 * 
 * Keyboard driver for config992 (Trinloc Orange Demo)
 */
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_2,  RKD_PRESET_3,     RKD_UNUSED,   RKD_UNUSED}, // Row 0
  {RKD_BACK,      RKD_REPLY,        RKD_UNUSED,   RKD_UNUSED}, // Row 1
  {RKD_PRESET_1,  RKD_SELECT,       RKD_UNUSED,   RKD_UNUSED}, // Row 2
...
static char acModuleName[] = "Reciva config992 Keypad Driver";
