/*
 * linux/reciva/reciva_keypad_config990.c
 *
 ...
 * 
 * Keyboard driver for config990 (Intempo Poppet)
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_UNUSED,    RKD_UP,         RKD_SELECT,   RKD_DOWN},     // Row 0
  {RKD_POWER,     RKD_UNUSED,     RKD_PRESET_6, RKD_VOL_UP},   // Row 1
  {RKD_PRESET_1,  RKD_BACK,       RKD_REPLY,    RKD_VOL_DOWN}, // Row 2
  {RKD_PRESET_2,  RKD_PRESET_3,   RKD_PRESET_4, RKD_PRESET_5}  // Row 3
};
