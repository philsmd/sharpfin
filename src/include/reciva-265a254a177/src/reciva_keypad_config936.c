/*
 * linux/reciva/reciva_keypad_config936.c
 *
 ...
 * 
 * Keyboard driver for config936 (IR705 - Adapter)
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_DOWN,      RKD_UNUSED,       RKD_UP,       RKD_UNUSED}, // Row 1
  {RKD_DOWN,      RKD_UNUSED,       RKD_UP,       RKD_UNUSED}, // Row 2
...
static char acModuleName[] = "Reciva config936 Keypad Driver";
