 ...
 * 
 * Keyboard driver for config869 (Tivoli SongBook 100)
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_UP,       RKD_DOWN,       RKD_SELECT,      RKD_PRESET_1}, // Row 0
  {RKD_BACK,     RKD_REPLY,      RKD_SLEEP_TIMER, RKD_PRESET_2}, // Row 1
  {RKD_ALARM,    RKD_PRESET_5,   RKD_PRESET_4,    RKD_PRESET_3}, // Row 2
  {RKD_POWER,    RKD_UNUSED,     RKD_UNUSED,      RKD_UNUSED}    // Row 3
};
