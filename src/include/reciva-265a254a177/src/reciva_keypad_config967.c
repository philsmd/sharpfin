/*
 * linux/reciva/reciva_keypad_config967.c
 *
 * This program is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License version 2 as
 * published by the Free Software Foundation.
 *
 * Copyright (c) 2006, 2007 Reciva Ltd. All Rights Reserved
 * 
 * Keyboard driver for config967
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_POWER,     RKD_UNUSED,       RKD_UNUSED,       RKD_DOWN},    // Row 0
  {RKD_PRESET_4,  RKD_SELECT,       RKD_ALARM,        RKD_BACK},    // Row 1
  {RKD_PRESET_3,  RKD_SNOOZE,       RKD_SLEEP_TIMER,  RKD_UP},      // Row 2
  {RKD_PRESET_2,  RKD_PRESET_1,     RKD_REPLY,        RKD_UNUSED}   // Row 3
};
...
static char acModuleName[] = "Reciva config967 Keypad Driver";
