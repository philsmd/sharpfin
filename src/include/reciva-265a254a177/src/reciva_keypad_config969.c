 ...
 * 
 * Keyboard driver for config969 (ARGON Cobal DAB 1)
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_5,  RKD_PRESET_6,    RKD_UNUSED,  RKD_UNUSED}, // Row 0
  {RKD_PRESET_4,  RKD_SLEEP_TIMER, RKD_SNOOZE,  RKD_SELECT}, // Row 1
  {RKD_PRESET_3,  RKD_BACK,        RKD_POWER,   RKD_UNUSED}, // Row 2
  {RKD_PRESET_2,  RKD_PRESET_1,    RKD_REPLY,   RKD_ALARM}  // Row 3
};
