/*
 * linux/reciva/reciva_keypad_config954.c
 *
 ...
 * 
 * Keyboard driver for config954 (VitaAudio)COBAL RD1)
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_5,  RKD_UNUSED,    RKD_UNUSED,      RKD_BACK},     // Row 0
  {RKD_PRESET_4,  RKD_REPLY,     RKD_SLEEP_TIMER, RKD_SELECT},    // Row 1
  {RKD_PRESET_3,  RKD_UNUSED,    RKD_POWER,       RKD_UNUSED},    // Row 2
  {RKD_PRESET_2,  RKD_PRESET_1,  RKD_UNUSED,      RKD_ALARM}       // Row 3
};
...
static char acModuleName[] = "Reciva config990 Keypad Driver";
