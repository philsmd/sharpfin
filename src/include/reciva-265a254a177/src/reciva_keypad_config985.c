/*
 * linux/reciva/reciva_keypad_config985.c
 *
 ...
 * 
 * Keyboard driver for Reciva config985
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_POWER,     RKD_UNUSED,        RKD_UNUSED,     RKD_UNUSED}, // Row 0
  {RKD_BACK,      RKD_SELECT,        RKD_REPLY,      RKD_UNUSED}, // Row 1
  {RKD_PRESET_1,  RKD_PRESET_2,      RKD_PRESET_3,   RKD_UNUSED}, // Row 2
...
static int aiKeysPresent[RKD_MAX_KEYS] =
{
  ...
  /* Remotes keys - 
   * Add any that need to be tested as part of the  manufacture test */
  RKD_MUTE,
  0,
  0,
  0,
...
static char acModuleName[] = "Reciva Config985 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Config985 Keypad Driver");
MODULE_LICENSE("GPL");
