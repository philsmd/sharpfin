/*
 * linux/reciva/reciva_keypad_config989.c
 *
 ...
 * 
 * Keyboard driver for Reciva config989
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_POWER,     RKD_PRESET_5,   RKD_BACK,         RKD_UNUSED}, // Row 0
  {RKD_PRESET_1,  RKD_PRESET_4,   RKD_AUDIO_SOURCE, RKD_UNUSED}, // Row 1
  {RKD_SELECT,    RKD_PRESET_3,   RKD_ALARM,        RKD_UNUSED}, // Row 2
  {RKD_PRESET_6,  RKD_PRESET_2,   RKD_REPLY,        RKD_SNOOZE}  // Row 3
};
...
static char acModuleName[] = "Reciva Config989 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Config989 Keypad Driver");
MODULE_LICENSE("GPL");
