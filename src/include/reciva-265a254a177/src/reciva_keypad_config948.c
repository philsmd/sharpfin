/*
 * linux/reciva/reciva_keypad_config948.c
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_3,  RKD_POWER,     RKD_SHIFT,        RKD_UP},     // Row 2
  {RKD_PRESET_2,  RKD_PRESET_1,  RKD_ALARM,        RKD_UNUSED}  // Row 3
};
...
static char acModuleName[] = "Reciva config948 Keypad Driver";
