/*
 * linux/reciva/reciva_keypad_config1011.c
 *
 ...
 * 
 * Keyboard driver for Reciva config1011
 *
...
static char acModuleName[] = "Reciva Config1011 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Config1011 Keypad Driver");
MODULE_LICENSE("GPL");
