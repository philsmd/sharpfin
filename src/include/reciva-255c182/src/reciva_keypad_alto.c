/*
 * linux/reciva/reciva_keypad_alto.c
 *
 ...
 * 
 * Keyboard driver for Reciva ALTO Application boards
 *
...
/* Driver functions */
static int alto_decode_key_press(int row, int column, int shift);
static int *alto_keys_present(void);
static int *alto_alt_key_functions(void);
...
static const int aacKeyDecodeShiftOff[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_1,  RKD_PRESET_2,  RKD_PRESET_3, RKD_UNUSED}, // Row 1
  {RKD_UNUSED,    RKD_PRESET_4,  RKD_PRESET_5, RKD_UNUSED}, // Row 2
  {RKD_SHIFT,     RKD_UNUSED,    RKD_POWER,    RKD_UNUSED}  // Row 3
};
...
static const int aacKeyDecodeShiftOn[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  /* Column 0     Column 1       Column 2        Column 3 */
  {RKD_BACK,      RKD_SELECT,    RKD_REPLY,    RKD_UNUSED}, // Row 0
  {RKD_PRESET_6,  RKD_PRESET_7,  RKD_PRESET_8, RKD_UNUSED}, // Row 1
  {RKD_UNUSED,    RKD_PRESET_9,  RKD_PRESET_10,RKD_UNUSED}, // Row 2
  {RKD_SHIFT,     RKD_UNUSED,    RKD_POWER,    RKD_UNUSED}  // Row 3
};
...
static char acModuleName[] = "Reciva Alto Keypad Driver";

static const reciva_keypad_driver_t driver =
{
  name:              acModuleName,
  decode_key_press:  alto_decode_key_press,
  keys_present:      alto_keys_present,
  alt_key_functions: alto_alt_key_functions,
};
