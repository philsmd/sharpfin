/*
 * linux/reciva/reciva_keypad_config1006.c
 *
 ...
 * 
 * Keyboard driver for Reciva Recess (config1006) Application boards
 *
...
/* Driver functions */
static int rkd_decode_key_press(int row, int column, int shift);
...
static const int aacKeyDecodeShiftOff[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_BACK,      RKD_SELECT,    RKD_POWER,    RKD_UNUSED}, // Row 0
  {RKD_PRESET_4,  RKD_REPLY,     RKD_SHIFT,    RKD_UNUSED}, // Row 1
  {RKD_PRESET_2,  RKD_UNUSED,    RKD_UNUSED,   RKD_UNUSED}, // Row 2
  {RKD_PRESET_3,  RKD_PRESET_5,  RKD_PRESET_1, RKD_UNUSED}  // Row 3
};
...
static const int aacKeyDecodeShiftOn[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  /* Column 0     Column 1       Column 2        Column 3 */
  {RKD_BACK,      RKD_SELECT,    RKD_POWER,    RKD_UNUSED}, // Row 0
  {RKD_PRESET_9,  RKD_REPLY,     RKD_SHIFT,    RKD_UNUSED}, // Row 1
  {RKD_PRESET_7,  RKD_UNUSED,    RKD_UNUSED,   RKD_UNUSED}, // Row 2
  {RKD_PRESET_8,  RKD_PRESET_10, RKD_PRESET_6, RKD_UNUSED}  // Row 3
};
...
static char acModuleName[] = "Reciva Config1006 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Config1006 Keypad Driver");
MODULE_LICENSE("GPL");
