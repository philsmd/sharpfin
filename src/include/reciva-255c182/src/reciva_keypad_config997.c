/*
 * linux/reciva/reciva_keypad_config997.c
 *
 ...
 * 
 * Keyboard driver for config997 (IR615 - Hipshing Adapter)
 *
...
/* Driver functions */
static int reciva_decode_key_press(int row, int column, int shift);
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_DOWN,      RKD_BROWSE_QUEUE, RKD_UP,       RKD_UNUSED}, // Row 1
  {RKD_VOL_DOWN,  RKD_UNUSED,       RKD_VOL_UP,   RKD_UNUSED}, // Row 2
  {RKD_UNUSED,    RKD_UNUSED,       RKD_POWER,    RKD_UNUSED}  // Row 3
};
...
static int aiKeysPresent[RKD_MAX_KEYS] =
{
  ...
  /* The following are only present on the remote. 
   * Having them listed here will mean that they need to be pressed 
   * during the manufacture test */
  RKD_PRESET_1,
  RKD_PRESET_2,
  RKD_PRESET_3,
  RKD_PRESET_4,
...
static int aiAlternateKeyFunctions[RKD_MAX_KEYS] =
{
  ...
  RKD_PLAYBACK_MODE, /* PRESET1 */
  RKD_STOP,          /* PRESET2 */
  RKD_SKIP_PREVIOUS, /* PRESET3 */
  RKD_PLAY_PAUSE,    /* PRESET4 */
  RKD_SKIP_NEXT,     /* PRESET5 */
  RKD_UNUSED,
  RKD_UNUSED,
  RKD_UNUSED,
  RKD_UNUSED,
...
static char acModuleName[] = "Reciva config997 Keypad Driver";
