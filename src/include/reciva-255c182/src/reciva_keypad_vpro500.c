/*
 * linux/reciva/reciva_keypad_stratas.c
 *
 ...
 * 
 * Keyboard driver for Reciva VPRO500 Application boards
 *
...
/* Driver functions */
static int vpro_decode_key_press(int row, int column, int shift);
static int *vpro_keys_present(void);
static int *vpro_alt_key_functions(void);
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_4,  RKD_PRESET_5,  RKD_PRESET_6, RKD_UNUSED}, // Row 2
  {RKD_PRESET_7,  RKD_PRESET_8,  RKD_POWER,    RKD_UNUSED}  // Row 3
};
...
static char acModuleName[] = "Reciva VPRO500 Keypad Driver";

static const reciva_keypad_driver_t driver =
{
  name:              acModuleName,
  decode_key_press:  vpro_decode_key_press,
  keys_present:      vpro_keys_present,
  alt_key_functions: vpro_alt_key_functions,
};
