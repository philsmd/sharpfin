 ...
 * 
 * Keyboard driver for config1012 (Hipshing Universal Radio)
 *
...
static const int aacKeyDecode[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  ...
  {RKD_PRESET_4,  RKD_PRESET_5,  RKD_BROWSE_QUEUE, RKD_UNUSED}, // Row 2
...
static char acModuleName[] = "Reciva config1012 Keypad Driver";
