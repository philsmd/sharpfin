...
{
  /* Column 0     Column 1       Column 2        Column 3 */
  {RKD_PRESET_6,  RKD_POWER,     RKD_REPLY,      RKD_UNUSED}, // Row 0
  {RKD_PRESET_7,  RKD_BACK,      RKD_SHIFT,      RKD_UNUSED}, // Row 1
  {RKD_PRESET_8,  RKD_UNUSED,    RKD_UNUSED,     RKD_UNUSED}, // Row 2
  {RKD_PRESET_9,  RKD_SELECT,    RKD_PRESET_10,  RKD_UNUSED}  // Row 3
};
