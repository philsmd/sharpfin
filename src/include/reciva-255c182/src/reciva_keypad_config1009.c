/*
 * linux/reciva/reciva_keypad_config1009.c
 *
 ...
 * 
 * Keyboard driver for Morphy Richards P1106 (config1009) Application boards
 *
...
static const int aacKeyDecodeShiftOn[RKD_NUM_ROWS][RKD_NUM_COLS] =
{
  /* Column 0     Column 1       Column 2        Column 3 */
  {RKD_BACK,      RKD_SELECT,    RKD_REPLY,    RKD_UNUSED}, // Row 0
  {RKD_PRESET_4,  RKD_PRESET_5,  RKD_PRESET_6, RKD_UNUSED}, // Row 1
  {RKD_UNUSED,    RKD_UNUSED,    RKD_UNUSED,   RKD_UNUSED}, // Row 2
  {RKD_SHIFT,     RKD_UNUSED,    RKD_POWER,    RKD_UNUSED}  // Row 3
};
...
static char acModuleName[] = "Reciva Config1009 Keypad Driver";
...
MODULE_DESCRIPTION("Reciva Config1009 Keypad Driver");
MODULE_LICENSE("GPL");
