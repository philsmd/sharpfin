...
extern int __init reciva_lcd_init(const struct reciva_lcd_driver *d, int h, int w);
extern void __exit reciva_lcd_exit(void);

extern char reciva_lcd_utf8_lookup(const char *utf8rep);
